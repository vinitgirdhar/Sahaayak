...
DEMO_PRODUCTS = [
    ('Organic Tomatoes', 'Vegetables', 45.0, 220, 'uploads/showcase/organic_tomatoes.svg', 534, 48),
    ('Fresh Spinach', 'Vegetables', 28.0, 90, 'uploads/showcase/fresh_spinach.svg', 412, 31),
    ('Premium Carrots', 'Vegetables', 36.0, 0, 'uploads/showcase/premium_carrots.svg', 275, 18),
    ('Red Onions', 'Vegetables', 32.0, 260, 'uploads/showcase/red_onions.svg', 486, 44),
    ('Green Capsicum', 'Vegetables', 58.0, 95, 'uploads/showcase/green_capsicum.svg', 298, 24),
    ('Fresh Broccoli', 'Vegetables', 82.0, 18, 'uploads/showcase/fresh_broccoli.svg', 240, 16),
    ('Cauliflower', 'Vegetables', 44.0, 70, 'uploads/showcase/cauliflower.svg', 215, 15),
    ('Cucumber', 'Vegetables', 30.0, 140, 'uploads/showcase/cucumber.svg', 325, 20),
    ('Toor Dal', 'Dry Ingredients', 118.0, 180, 'uploads/showcase/toor_dal.svg', 288, 21),
    ('Besan (Gram Flour)', 'Dry Ingredients', 72.0, 140, 'uploads/showcase/besan.svg', 214, 13),
    ('Fresh Milk (1L)', 'Dairy Products', 58.0, 90, 'uploads/showcase/fresh_milk.svg', 264, 18),
    ('Paneer (200g)', 'Dairy Products', 96.0, 60, 'uploads/showcase/paneer.svg', 241, 17),
    ('White Bread', 'Bread & Bakery', 40.0, 120, 'uploads/showcase/white_bread.svg', 212, 14),
    ('Burger Buns (4pc)', 'Bread & Bakery', 52.0, 80, 'uploads/showcase/burger_buns.svg', 196, 12),
    ('Instant Noodles Pack', 'Ready-to-Eat', 24.0, 250, 'uploads/showcase/instant_noodles.svg', 318, 22),
    ('Frozen Veg Momos (10pc)', 'Ready-to-Eat', 135.0, 50, 'uploads/showcase/veg_momos.svg', 186, 15),
    ('Basmati Rice', 'Grains & Cereals', 85.0, 150, 'uploads/showcase/basmati_rice.svg', 445, 25),
    ('Basmati Rice (1kg)', 'Grains & Cereals', 125.0, 180, 'uploads/showcase/basmati_rice.svg', 390, 29),
    ('Turmeric Powder (100g)', 'Spices & Condiments', 42.0, 160, 'uploads/showcase/turmeric_powder.svg', 344, 22),
    ('Cumin Seeds (100g)', 'Spices & Condiments', 72.0, 130, 'uploads/showcase/cumin_seeds.svg', 268, 17),
    ('Peanut Butter (250g)', 'Spreads & Pantry', 185.0, 75, 'uploads/showcase/peanut_butter.svg', 301, 26),
    ('Tea (250g)', 'Snacks & Beverages', 180.0, 90, 'uploads/showcase/tea.svg', 223, 14),
    ('Sunflower Oil (1L)', 'Oils & Condiments', 155.0, 60, 'uploads/showcase/sunflower_oil.svg', 248, 19),
    ('Mango Juice (1L)', 'Snacks & Beverages', 112.0, 85, 'uploads/showcase/mango_juice.svg', 201, 12),
    ('Disposable Plates (50pc)', 'Other', 120.0, 70, 'uploads/showcase/disposable_plates.svg', 174, 10),
    ('Gulab Jamun Mix', 'Other', 88.0, 65, 'uploads/showcase/gulab_jamun_mix.svg', 208, 16),
    ('Eggs (12pc)', 'Other', 90.0, 120, 'uploads/showcase/eggs.svg', 236, 18),
]
